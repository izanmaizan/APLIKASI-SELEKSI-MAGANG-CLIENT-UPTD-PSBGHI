...
class _TambahScreenState extends State<TambahScreen> {
  ...
  // TextEditingController jenis_kelamin_client = TextEditingController();
  TextEditingController umur_client = TextEditingController();
  // TextEditingController klasifikasi_kecacatan_client = TextEditingController();
  ...
  void simpanData() async {
    ...
    if (nama.text.isNotEmpty) {
      ...
      myListProvider.setShowDialog('Data Sudah Ditambahkan');
